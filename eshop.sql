...
--
-- Host: localhost
-- Generation Time: Oct 03, 2015 at 01:28 AM
...
ALTER TABLE `purchase_products`
  ...
  ADD CONSTRAINT `purchase_products_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
